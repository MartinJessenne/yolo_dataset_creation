---
source: https://docs.isaacsim.omniverse.nvidia.com/latest/replicator_tutorials/tutorial_replicator_isaac_randomizers.html
---

# Randomization Snippets[#](https://docs.isaacsim.omniverse.nvidia.com/latest/replicator_tutorials/tutorial_replicator_isaac_randomizers.html#randomization-snippets "Link to this heading")
...
Prerequisites:
  ...
  * Ability to execute code from the [Script Editor](https://docs.isaacsim.omniverse.nvidia.com/latest/development_tools/omniverse_script_editor.html#script-editor).
...
## Randomizing Light Sources[#](https://docs.isaacsim.omniverse.nvidia.com/latest/replicator_tutorials/tutorial_replicator_isaac_randomizers.html#randomizing-light-sources "Link to this heading")
...
[![../_images/isaac_tutorial_replicator_randomization_lights.gif](https://docs.isaacsim.omniverse.nvidia.com/latest/_images/isaac_tutorial_replicator_randomization_lights.gif) ](https://docs.isaacsim.omniverse.nvidia.com/latest/_images/isaac_tutorial_replicator_randomization_lights.gif) Randomizing Light Sources
...
```
Copy to clipboard
## Randomizing Textures[#](https://docs.isaacsim.omniverse.nvidia.com/latest/replicator_tutorials/tutorial_replicator_isaac_randomizers.html#randomizing-textures "Link to this heading")
...
[![../_images/isaac_tutorial_replicator_randomization_textures.gif](https://docs.isaacsim.omniverse.nvidia.com/latest/_images/isaac_tutorial_replicator_randomization_textures.gif) ](https://docs.isaacsim.omniverse.nvidia.com/latest/_images/isaac_tutorial_replicator_randomization_textures.gif) Randomizing Textures
...
```
Copy to clipboard
## Sequential Randomizations[#](https://docs.isaacsim.omniverse.nvidia.com/latest/replicator_tutorials/tutorial_replicator_isaac_randomizers.html#sequential-randomizations "Link to this heading")
...
[![../_images/isaac_tutorial_replicator_randomization_chained_persp.gif](https://docs.isaacsim.omniverse.nvidia.com/latest/_images/isaac_tutorial_replicator_randomization_chained_persp.gif) ](https://docs.isaacsim.omniverse.nvidia.com/latest/_images/isaac_tutorial_replicator_randomization_chained_persp.gif) [![../_images/isaac_tutorial_replicator_randomization_chained_sphere.gif](https://docs.isaacsim.omniverse.nvidia.com/latest/_images/isaac_tutorial_replicator_randomization_chained_sphere.gif) ](https://docs.isaacsim.omniverse.nvidia.com/latest/_images/isaac_tutorial_replicator_randomization_chained_sphere.gif) Sequential Randomizations
...
```
Copy to clipboard
## Physics-based Randomized Volume Filling[#](https://docs.isaacsim.omniverse.nvidia.com/latest/replicator_tutorials/tutorial_replicator_isaac_randomizers.html#physics-based-randomized-volume-filling "Link to this heading")
...
[![../_images/isaac_tutorial_replicator_randomization_volume_fill.gif](https://docs.isaacsim.omniverse.nvidia.com/latest/_images/isaac_tutorial_replicator_randomization_volume_fill.gif) ](https://docs.isaacsim.omniverse.nvidia.com/latest/_images/isaac_tutorial_replicator_randomization_volume_fill.gif) [![../_images/isaac_tutorial_replicator_randomization_volume_fill_warehouse.gif](https://docs.isaacsim.omniverse.nvidia.com/latest/_images/isaac_tutorial_replicator_randomization_volume_fill_warehouse.gif) ](https://docs.isaacsim.omniverse.nvidia.com/latest/_images/isaac_tutorial_replicator_randomization_volume_fill_warehouse.gif) Physics-based Randomized Volume Filling
...
```
Copy to clipboard
## Simready Assets SDG Example[#](https://docs.isaacsim.omniverse.nvidia.com/latest/replicator_tutorials/tutorial_replicator_isaac_randomizers.html#simready-assets-sdg-example "Link to this heading")
...
```
Copy to clipboard
![../_images/isim_5.0_replicator_tut_viewport_randomization_simready_assets.jpg](https://docs.isaacsim.omniverse.nvidia.com/latest/_images/isim_5.0_replicator_tut_viewport_randomization_simready_assets.jpg)
Script Editor
